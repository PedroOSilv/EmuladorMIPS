...
void I_inst(word instruction, byte opcode){
    ...
    case 0x23:
        // lw
        REG[rt] = MEM[REG[rs] + immediate] << 24;
        REG[rt] |= MEM[REG[rs] + immediate + 1] << 16;
        REG[rt] |= MEM[REG[rs] + immediate + 2] << 8;
        REG[rt] |= MEM[REG[rs] + immediate + 3];
        break;
    case 0x21:
        // lh
        REG[rt] = MEM[REG[rs] + immediate] << 8;
        REG[rt] |= MEM[REG[rs] + immediate + 1];
        break;
    case 0x20:
        // lb
